...
# Example usage
# Assume we have a binary text file named "binary_data.txt"
# The function can be called like this to convert its content to a list of integers:
integers = load_binary_file("./memcpy_exec")
print(integers)
